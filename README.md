...
> ### ВАЙБКОД
>
> Библиотека создана с минимальным контролем кода и правками, потому что на рынке npm я до сих пор не видел никаких альтернатив
> Я не обязываю вас использовать эту библиотеку, но буду рад вашим звёздам, форкам и [issue](https://github.com/ichh0/discord-components-v2/issues).
